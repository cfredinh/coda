...
# from utils import is_parallel, CosineSchedulerWithWarmup, cancel_gradients, ddp_is_on


        
# __all__ = ['DINOTrainer', 'DINO_to_classifier']
...
class DINOTrainer(BYOLTrainer):
    def __init__(self, wraped_defs, freeze_last_for=1):
        ...
        self.decay_scheduler = CosineSchedulerWithWarmup(
            ...
            final_value=1e-4, iters=len(self.trainloader)*self.epochs)  
