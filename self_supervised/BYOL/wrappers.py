...
class BYOLWrapper(DefaultWrapper):
    def __init__(self, parameters, use_momentum=True, aug_strat_path=None, test_all=False):
        super().__init__(parameters, aug_strat_path=aug_strat_path, test_all=test_all)
